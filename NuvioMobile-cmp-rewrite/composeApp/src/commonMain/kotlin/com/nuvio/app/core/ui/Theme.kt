...
import com.nuvio.app.features.settings.ThemeMode
...
private fun buildColorScheme(palette: ThemeColorPalette, darkTheme: Boolean, amoled: Boolean = false) =
    if (darkTheme) darkColorScheme(
        primary = palette.secondary, onPrimary = palette.onSecondary,
        primaryContainer = palette.focusBackground, onPrimaryContainer = contentColorFor(palette.focusBackground),
        secondary = palette.secondaryVariant, onSecondary = palette.onSecondaryVariant,
        background = if (amoled) Color.Black else palette.background, onBackground = Color(0xFFF5F7F8),
        surface = palette.backgroundElevated, onSurface = Color(0xFFF5F7F8),
        surfaceVariant = palette.backgroundCard, onSurfaceVariant = Color(0xFF969CA3),
        outline = Color(0xFF252A2A), error = Color(0xFFE36A8A), onError = Color(0xFFFCE5EC),
    ) else lightColorScheme(
        primary = palette.secondary, onPrimary = palette.onSecondary,
        primaryContainer = palette.focusRing.copy(alpha = 0.16f), onPrimaryContainer = Color(0xFF161616),
        secondary = palette.secondaryVariant, onSecondary = palette.onSecondaryVariant,
        background = Color(0xFFF6F7F9), onBackground = Color(0xFF17191D),
        surface = Color(0xFFFFFFFF), onSurface = Color(0xFF17191D),
        surfaceVariant = Color(0xFFECEEF2), onSurfaceVariant = Color(0xFF59616B),
        outline = Color(0xFFD0D5DC), error = Color(0xFFBA1A1A), onError = Color.White,
    )
