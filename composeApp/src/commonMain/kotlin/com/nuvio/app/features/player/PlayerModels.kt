...
enum class VisualEnhancerMode(
    ...
    Cinema(
        label = "Cinema",
        description = "Warm cinematic contrast and shadow enhancement for movies.",
    ),
    Ultra(
        label = "Ultra / HDR Pop",
        description = "Maximum vibrance, deep blacks, and punchy saturation for animation and dark scenes.",
    ),
    Custom(
        label = "Custom",
        description = "Fine-tune brightness, contrast, saturation, and gamma with manual sliders.",
    ),
}
