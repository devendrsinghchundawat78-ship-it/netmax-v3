    ...
    AndroidView(
        ...
        factory = { viewContext ->
            ...
            playerView.apply {
                ...
                applyVisualEnhancer(
                    enabled = playerSettingsUiState.visualEnhancerEnabled,
                    mode = playerSettingsUiState.visualEnhancerMode,
                    customBrightness = playerSettingsUiState.iosBrightness,
                    customContrast = playerSettingsUiState.iosContrast,
                    customSaturation = playerSettingsUiState.iosSaturation,
                )
            }
        },
        update = { playerView ->
            ...
            playerView.applyVisualEnhancer(
                enabled = playerSettingsUiState.visualEnhancerEnabled,
                mode = playerSettingsUiState.visualEnhancerMode,
                customBrightness = playerSettingsUiState.iosBrightness,
                customContrast = playerSettingsUiState.iosContrast,
...
private fun LibmpvPlayerSurface(
    ...
    LaunchedEffect(
        playerViewRef,
        playerSettingsUiState.visualEnhancerEnabled,
        playerSettingsUiState.visualEnhancerMode,
        playerSettingsUiState.iosBrightness,
        playerSettingsUiState.iosContrast,
        playerSettingsUiState.iosSaturation,
        playerSettingsUiState.iosGamma,
    ) {
        playerViewRef?.syncVisualEnhancer(
            enabled = playerSettingsUiState.visualEnhancerEnabled,
            mode = playerSettingsUiState.visualEnhancerMode,
            customBrightness = playerSettingsUiState.iosBrightness,
            customContrast = playerSettingsUiState.iosContrast,
            customSaturation = playerSettingsUiState.iosSaturation,
            customGamma = playerSettingsUiState.iosGamma,
        )
    }
...
private class NuvioLibmpvView(
    ...
    fun syncVisualEnhancer(
        enabled: Boolean,
        mode: VisualEnhancerMode,
        customBrightness: Int,
        customContrast: Int,
                ...
                if (!enabled) {
                    ...
                    val (c, b, s, g, sh) = when (mode) {
                        ...
                        VisualEnhancerMode.Custom -> listOf(
                            ...
                            customSaturation.toDouble(),
                            customGamma.toDouble(),
                            0.0,
                        )
                    }
                    mpv.setPropertyInt("contrast", c.toInt())
...
private fun PlayerView.applyVisualEnhancer(
    enabled: Boolean,
    mode: VisualEnhancerMode,
    customBrightness: Int,
    customContrast: Int,
