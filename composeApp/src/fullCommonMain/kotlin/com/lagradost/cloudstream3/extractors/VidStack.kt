...
object AesHelper {
    fun decryptAES(inputHex: String, key: String, iv: String): String {
        ...
        cipher.init(
            ...
            javax.crypto.spec.SecretKeySpec(key.encodeToByteArray(), "AES"),
            javax.crypto.spec.IvParameterSpec(iv.encodeToByteArray())
        )
        return cipher.doFinal(inputHex.hexToByteArray()).decodeToString()
    }
